...
pin(DATALOGGER_RS485_0_TX_ENABLE, PD5, OUTPUT)
pin(DATALOGGER_RS485_0_RX_DISABLE, PD4, OUTPUT)
pin(DATALOGGER_S0_IMPULS, PD6, INPUT)


pin(DATALOGGER_RS485_1_TX_ENABLE, PC2, OUTPUT)
pin(DATALOGGER_RS485_1_RX_DISABLE, PC3, OUTPUT)

/* Yellow Led teilt sich mit Goodwe */
